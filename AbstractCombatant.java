...
import models.stats.AttributeManager;
...
public abstract class AbstractCombatant implements Combatant {
    ...
    public void takeDamage(int damage) {
        ...
        int actualDamage = AttributeManager.calculateDamage(damage, getDefense());
    ...
    public void heal(int amount) {
        ...
        int oldHp = currentHp;
        currentHp = AttributeManager.clampHp(currentHp + amount);
